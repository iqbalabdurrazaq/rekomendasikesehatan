...
$(document).ready(function() {
    ...
    document.getElementById("avgN2").style.display = "none";
    var offset = 0;
    getHum();
    function getHum()
    {
      var xNo = new Array();
      var yHum = new Array();
      var url = "http://localhost/rekomendasikesehatan/Raspi04/api/apiGetDataJson_hum.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
  ...
  function predictHum(X, Y)
  {
    ...
    var plotObj2 = $.plot($("#flot-line-chart4"), [{
    ...
    document.getElementById('avgData3').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgData4').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgMse2').innerHTML = "Mean Square Error: <b>" + vMse+"<b>";
    document.getElementById('avgMape2').innerHTML = "Mean Absolute Persen Error: <b>" + vMape +"<b>";
    document.getElementById('avgMad2').innerHTML = "Mean Absolute Deviation Error: <b>" + vMad +"<b>";
    document.getElementById('avgN2').innerHTML = yPred;
  }  
});