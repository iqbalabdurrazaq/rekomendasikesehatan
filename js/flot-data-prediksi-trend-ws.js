...
$(document).ready(function() {
    ...
    function getHum()
    {
      var xNo = new Array();
      var yHum = new Array();
      var url = "http://localhost/rekomendasikesehatan/Raspi04/api/apiGetDataJson_ws.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
        ...
        success: function(response){           
          for(i=0;i<response.records.length;i++){
            ...
            yHum[i] = parseInt(response.records[i].ws);
            console.log(yHum[i]);                  
          }
          predictHum(xNo, yHum);
        }            
  ...
  function predictHum(X, Y)
  {
    ...
    document.getElementById('avgData7').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgData8').innerHTML = "Forecast Error : <b>" +vErr +"<b>";
    document.getElementById('avgMse4').innerHTML = "Mean Square Error: <b>" + vMse+"<b>";
    document.getElementById('avgMape4').innerHTML = "Mean Absolute Persen Error: <b>" + vMape +"<b>";
    document.getElementById('avgMad4').innerHTML = "Mean Absolute Deviation Error: <b>" + vMad +"<b>";
