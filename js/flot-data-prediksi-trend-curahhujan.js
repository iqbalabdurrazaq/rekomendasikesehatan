...
$(document).ready(function() {
    ...
    document.getElementById("avgN3").style.display = "none";
    var offset = 0;
    getHum();
    function getHum()
    {
      var xNo = new Array();
      var yHum = new Array();
      var url = "http://localhost/rekomendasikesehatan/Raspi04/api/apiGetDataJson_curahHujan.php";
      $.ajax({   
      type: "GET",    
        url: url,
        dataType: 'json',
        ...
        success: function(response){           
          for(i=0;i<response.records.length;i++){
            ...
            yHum[i] = parseInt(response.records[i].curahHujan);
            console.log(yHum[i]);                  
          }
          predictHum(xNo, yHum);
        }            
  ...
  function predictHum(X, Y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart5"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart6"), [{
    ...
    document.getElementById('avgData5').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgData6').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgMse3').innerHTML = "Mean Square Error: <b>" + vMse+"<b>";
    document.getElementById('avgMape3').innerHTML = "Mean Absolute Persen Error: <b>" + vMape +"<b>";
    document.getElementById('avgMad3').innerHTML = "Mean Absolute Deviation Error: <b>" + vMad +"<b>";
    document.getElementById('avgN3').innerHTML = yPred;
  }  
});